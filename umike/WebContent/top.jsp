...
<body style="background:url(images/topbg.gif) repeat-x;">
  	...
  	TongzhiServices ton=new TongzhiServices();
	stutag stu=new stutag();
	stu=(stutag)ton.countTag(student_ID);
	request.getSession().setAttribute("count",stu);
	stu=(stutag)request.getSession().getAttribute("count");
	String a=stu.getTagcount();
	request.getSession().setAttribute("stuaa",a);
	%>
    <div class="topleft">
   ...
   <!--  <ul class="nav">
    ...
    <div class="user">
    <span> <%= request.getSession().getAttribute("id")%> </span>
    <i>消息</i>
    <b><%=request.getSession().getAttribute("stuaa")%></b>
    </div>    
